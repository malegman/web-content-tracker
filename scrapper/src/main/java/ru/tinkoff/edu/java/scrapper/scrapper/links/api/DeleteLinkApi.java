package ru.tinkoff.edu.java.scrapper.scrapper.links.api;
...
/**
 * API для удаления отслеживаемой ссылки чата телеграмма
 */
public abstract class DeleteLinkApi extends Invocation<DeleteLinkApi.Payload,
        DeleteLinkApi.Payload.Builder, DeleteLinkApi.Result, DeleteLinkApi.Result.Visitor> {
    ...
    public record Payload(TgChatId tgChatId, String url) implements Invocation.Payload {
        ...
        public static final String ERROR_TG_CHAT_ID = "links.delete.errors.tg_chat_id";
        public static final String ERROR_URL = "links.delete.errors.url";
