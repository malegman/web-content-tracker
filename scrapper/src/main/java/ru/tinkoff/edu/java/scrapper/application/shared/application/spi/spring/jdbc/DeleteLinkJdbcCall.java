...
/**
 * Реализация {@link DeleteLinkSpi}, с использованием {@link SimpleJdbcCall}
 */
public final class DeleteLinkJdbcCall extends SimpleJdbcCall implements DeleteLinkSpi {
    ...
    public DeleteLinkJdbcCall(final DataSource dataSource) {
        super(dataSource);
