...
public class UnTrackGreetingCommandInnerFunctionTest {

    UnTrackGreetingCommandInnerFunction handler;

    @BeforeEach
    void setUp() {
        this.handler = new UnTrackGreetingCommandInnerFunction();
    }

    @Test
    void unTrackGreetingCommand_Request_ReturnsSuccessResult() {
        ...
        assertEquals("Введите ссылку для удаления из отслеживания.",
